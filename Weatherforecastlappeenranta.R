...
# Ljung-Box p-value 0.24, residual plots ok
...
# Ljung-Box p-value 0.27, residual plots ok
# Residuals almost identical with Arimaown, choosing Arimaauto as the model to go with (lower complexity)


## Forecasting average temperature for the next 12 months

Forecast2021 = forecast(Arimaauto, h = 12)
autoplot(Forecast2021)
